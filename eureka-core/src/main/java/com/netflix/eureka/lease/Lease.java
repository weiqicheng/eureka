...
public class Lease<T> {
    ...
    public void renew() {
        /**
         * 每次client服务发送一次心跳，其实就是靠刷新这个lastUpdateTimestamp 类似于是最近一次活跃时间。
         */
    ...
    public boolean isExpired(long additionalLeaseMs) {
        /**
         * 每次client发送心跳时会刷新lastUpdateTimestamp这个值为：lastUpdateTimestamp = System.currentTimeMillis() + duration;
         * 现在这个方法是：判断了当前是否大于了上次心跳时间再加上续约到期时间（默认90秒）再加上补偿时间
         */
