            ...
            public void run() {
                ...
                for (Key key : readOnlyCacheMap.keySet()) {
                    ...
                    try {
                        ...
                        /**
                         * 对readWriteCacheMap跟readOnlyCacheMap数据进行比对
                         * 如果不相等则把readWriteCacheMap的数据设置到readOnlyCacheMap中
                         */
                ...
                case Application:
                    ...
                    if (ALL_APPS.equals(key.getName())) {
                        if (isRemoteRegionRequested) {
                            ...
                            /**
                             * registry.getApplications()表示在注册表中进行读取application的信息
                             * getPayLoad方法将application对象序列化成了json
                             */
                    ...
                    //获取增量的实例信息
                        ...
                        if (isRemoteRegionRequested) {
                            ...
                            //registry.getApplicationDeltasFromMultipleRegions(key.getRegions())进行获取增量的服务实例信息
